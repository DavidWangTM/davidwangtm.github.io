...
###[View Live DavidWang Blog &rarr;](http://davidwangtm.github.io/)
...
```
# Site settings
title: DavidWangTM's Blog             # title of your website
SEOTitle: DavidWangTM's Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: DavidWangTM    # modify this account to yours
weibo_username: DavidWangTM      # the footer woule be auto-updated.
...
---
layout:     keynote
iframe:     "http://yourwebsite/yourpost"
---
```
...
Before, site setting `title` is not only used for displayed in Home Page and Navbar, but also used to generate the `<title>` in HTML.
It's possible that you want the two things different. For me, my site-title is **“DavidWangTM's Blog”** but I want the title shows in search engine is **“王伟达的博客 | DavidWangTM's Blog”** which is multi-language.
