...
## 2. UML类图
![uml](/img/in-post/android_introduction/android_prototype-uml.png)
...
```
输出结果如下 :     
![result](/img/in-post/android_introduction/android_yx_result.png)
...
输出结果如下 :  
![result](/img/in-post/android_introduction/android_yx_result-2.png)       
...
![result](/img/in-post/android_introduction/android_yx_result-3.png)        
...
![result](/img/in-post/android_introduction/android_sms.png)        
