...
## 2. UML类图
 ![url](/img/in-post/android_introduction/android_facade_uml.png)
...
## 不使用外观模式
 ![url](/img/in-post/android_introduction/android_no_facade_uml.png)     
...
![context](/img/in-post/android_introduction/android_contextimpl.png)
